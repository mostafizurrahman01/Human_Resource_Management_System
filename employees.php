	...
	<nav>
        ...
        <div class = "container-wrapper">
            <div class="container">
                ...
                <a href="registered_employee.php">View</a>
            </div>
            <div class="container">
                <h2>Add Employee</h2>
            ...
            <div class="container">
                ...
                <a href="advancedSearch_employee.php">Advanced Search</a>
            </div>
            <!-- <div class="container">
            ...
            <div class="container">
                <h2>Employees Without Phone Numbers</h2>
            ...
            <div class="container">
                <h2>Employees with Incomplete Address</h2>
                <a href="view_user_incompleteAddress.php">View List</a>
            </div>
            <div class="container">
                <h2>Employees Count by Location</h2>
